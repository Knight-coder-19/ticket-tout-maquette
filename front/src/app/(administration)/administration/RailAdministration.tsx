...
/**
 * Rail minimal : l'espace administration n'est pas encore construit, mais le
 * logotype Ticket Tout doit etre present dans les trois espaces (mail Sellami).
 */
export function RailAdministration() {
  return (
    <nav className={styles.railStub} aria-label="Espace administration">
      <Logo hauteur={22} mono />
      <span className={styles.railStubSim}>simulation</span>
      <p className={styles.railStubEspace}>Espace administration</p>
