...
| Carte « désirable », au repos et au paiement, captures réelles | ✅ concept « Le Ticket » ; `src/components/marque/CarteVisuelle.tsx` ; captures dans le book |
...
réelles), interdits (5, dont 3 tirés de notre propre interface), périmètre.
...
| **Vidéo** | Les prises disent « CartePro » à l'écran et à l'oral. À refaire une fois l'interface validée. | Traité à part ; l'interface est prête pour re-tourner le parcours. |
